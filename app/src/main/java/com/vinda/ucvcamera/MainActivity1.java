 ...
 * 显示多路摄像头
 */
public class MainActivity1 extends BaseActivity implements CameraDialog.CameraDialogParent {
    ...
    private ImageView frame_image_first,capture_button_second,frame_image_second,frame_image_fourth,frame_image_fifth,frame_image_sixth;
    private ImageButton camera_button_first;
    ...
    private void resultSecondCamera() {
        ...
        capture_button_second = findViewById(R.id.capture_button_second);
                ...
                case R.id.camera_view_first:
                    if (mHandlerFirst != null) {
                        if (!mHandlerFirst.isOpened()) {
                            ...
                            CameraDialog.showDialog(MainActivity1.this);
                        } else {
                            mHandlerFirst.close();
                ...
                case R.id.camera_view_second:
                    if (mHandlerSecond != null) {
                        if (!mHandlerSecond.isOpened()) {
                            capture_button_second.setVisibility(View.GONE);
                            CameraDialog.showDialog(MainActivity1.this);
                        } else {
                            capture_button_second.setVisibility(View.VISIBLE);
                            mHandlerSecond.close();
                            setCameraButton();
                        }
                    }
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
        ...
        public void onAttach(final UsbDevice device) {
            ...
            Toast.makeText(MainActivity1.this, "USB_DEVICE_ATTACHED", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onDettach(final UsbDevice device) {
            ...
            Toast.makeText(MainActivity1.this, "USB_DEVICE_DETACHED", Toast.LENGTH_SHORT).show();
        }
